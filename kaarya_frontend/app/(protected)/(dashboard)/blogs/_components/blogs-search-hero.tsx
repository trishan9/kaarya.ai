...
export function BlogsSearchHero({
  ...
  const preserveCategory =
    selectedFilterId && selectedFilterId !== "the-latest" ? selectedFilterId : null;
  ...
  return (
    <section className="relative overflow-hidden rounded-2xl bg-linear-to-r from-[#00629F]/80 to-[#00629F] px-4 py-8 text-white sm:px-8">
      ...
      <div className="relative z-10 space-y-5">
        ...
        <form action="/blogs" className="rounded-xl bg-white p-1.5 shadow-sm dark:bg-[#f8fbff]/95">
          {preserveCategory ? (
            <input type="hidden" name="category" value={preserveCategory} />
          ) : null}
          <div className="grid gap-1 md:grid-cols-[minmax(0,1fr)_120px]">
