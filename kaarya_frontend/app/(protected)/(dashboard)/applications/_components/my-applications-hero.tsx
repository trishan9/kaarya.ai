export type MyApplicationsHeroStat = {
  id: string;
  label: string;
  value: string;
};

export type MyApplicationsHeroProps = {
  title: string;
  description: string;
  lastUpdatedLabel: string;
  stats: MyApplicationsHeroStat[];
};

export function MyApplicationsHero({
  title,
  description,
  lastUpdatedLabel,
  stats,
}: MyApplicationsHeroProps) {
  return (
