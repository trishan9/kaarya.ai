            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-44">
                <DropdownMenuItem asChild>
                  <Link href={buildScopeHref("global")} className="flex items-center justify-between">
                    <span>Global leaderboard</span>
                    {activeScope === "global" ? <Check className="h-3.5 w-3.5" /> : null}
                  </Link>
                </DropdownMenuItem>
                {selectedCollegeId ? (
                  <DropdownMenuItem asChild>
                    <Link href={buildScopeHref("college")} className="flex items-center justify-between">
                      <span>College leaderboard</span>
                      {activeScope === "college" ? <Check className="h-3.5 w-3.5" /> : null}
                    </Link>
                  </DropdownMenuItem>
                ) : null}
              </DropdownMenuContent>
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-wrap items-center gap-3 text-xs text-muted-foreground sm:text-sm">
                  {isCurrentUser ? <span className="font-medium text-primary">You</span> : null}
                  <span>
                    XP <span className="font-semibold text-foreground">{row.xp}</span>
                  </span>
                  ...
                  <span className="inline-flex items-center gap-1">
                    K-Rank <span className="font-semibold text-foreground">{totalPoints(row)}</span>
                    <LeaderboardInsightsTooltip row={row} triggerClassName="text-muted-foreground" />
                  </span>
                </div>
              </div>
            );
