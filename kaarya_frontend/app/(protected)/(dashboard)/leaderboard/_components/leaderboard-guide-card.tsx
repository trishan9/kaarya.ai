...
export const LeaderboardGuideCard = ({
  ...
  return (
    <Card className="rounded-xl border border-border bg-card p-3 shadow-sm sm:p-4">
      <div className="space-y-1">
        <p className="text-sm font-semibold text-foreground">How Ranking Works</p>
      ...
      <div className="mt-3 grid gap-3 lg:grid-cols-[minmax(0,1.25fr)_minmax(0,0.75fr)]">
        <div className="rounded-lg border border-border bg-muted/40 p-3 text-xs text-foreground">
          <p className="font-semibold text-foreground">K-Rank Formula</p>
          ...
          <div className="mt-2 overflow-hidden rounded-md border border-border bg-card">
            <div className="grid grid-cols-2 border-b border-border bg-muted/40 px-2 py-1 text-[11px] font-semibold text-foreground">
            ...
            <div className="grid grid-cols-2 border-t border-border/60 px-2 py-1 text-[11px]">
              <span>60-79</span>
              <span>90%</span>
            </div>
            <div className="grid grid-cols-2 border-t border-border/60 px-2 py-1 text-[11px]">
        ...
        <div className="rounded-lg border border-border bg-muted/40 p-3 text-xs text-foreground">
          <p className="font-semibold text-foreground">Progress Guide</p>
