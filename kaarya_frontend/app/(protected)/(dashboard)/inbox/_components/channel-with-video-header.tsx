...
function StreamChannelHeader({
  ...
  return (
    <div className="flex items-center justify-between border-b border-border bg-card dark:bg-[#111824] px-5 py-3.5">
      <div className="flex min-w-0 items-center gap-3">
        ...
        <div className="min-w-0">
          <p className="truncate text-[1.03rem] font-semibold leading-tight text-foreground">
            {displayName}
          </p>
          ...
          <>
            {hasActiveCallInChannel && !inCurrentChannelCall ? (
              <Button
                ...
                variant="outline"
                size="sm"
                className="h-8 rounded-full border-primary/30 bg-primary/15 px-3 text-xs font-semibold text-primary hover:bg-primary/20"
                disabled={isBusy}
                onClick={() => {
            ...
            {inCurrentChannelCall && isHuddleMinimized ? (
              <Button
                ...
                variant="outline"
                size="sm"
                className="h-8 rounded-full border-border bg-card dark:bg-[#111824] px-3 text-xs font-semibold text-foreground hover:bg-accent"
...
export function ChannelWithVideoHeader({
  ...
  const emptyPlaceholder = (
    <div className="flex h-full flex-col items-center justify-center bg-card px-6 text-center">
      <p className="text-[1.9rem] font-semibold tracking-tight text-foreground sm:text-[2.05rem]">
