...
export function SigninForm() {
  ...
  const oauthNotice = pendingLinkToken
    ? `Sign in with your existing account to link ${
        pendingProvider || "your social provider"
      }.`
    : oauthError &&
  ...
  const handleOAuthSignIn = (provider: "google" | "github") => {
    ...
    if (pendingLinkToken) {
      redirectUri.searchParams.set("linkToken", pendingLinkToken);
    }
    ...
    authorizeUrl.searchParams.set("redirectUri", redirectUri.toString());
    authorizeUrl.searchParams.set("intent", "login");
